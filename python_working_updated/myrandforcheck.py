...
def train_model(train_data_X, train_data_y):
    ...
    print("RANDOM FOREST (Training):", classification_report(mypred, predcheck))
...
def makepred(mymod, mytestdata):
    ...
    arrcheck = [0, 0]
    predict_val = list(mymod.classes_)
...
if __name__ == '__main__':
    ...
    if "testrandfor" not in os.listdir() :
        ...
        #print(evaluate_model(testmodelrandfor, mytest_X, mytest_y))
        #print(os.listdir())
        #os.chdir("..")
    ...
    #print(os.getcwd())
    #os.chdir("python_working_updated")
    if list(sys.argv)[1].find(".csv") >= 0 :
    ...
    result = testmodelrandfor.predict(mydfdata_train)
    print(result[0])
