...
public class OculusSensorCapture : MonoBehaviour
{
    ...
    // update later once activities are finalized
    private (string, string)[] activities = {("NBR", "Normal Breathing"),("SBR", "Stressed Breathing"), 
        ("DBR", "Deep Breathing"),("NMV", "Normal Movement"), ("EMV", "Erratic Movement")}
